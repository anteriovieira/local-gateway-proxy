...
import { X, Settings, Pencil, Link2, Radio } from 'lucide-react'
...
export const SettingsModal: React.FC<SettingsModalProps> = ({ workspace, isOpen, onClose, onUpdate, variant = 'desktop' }) => {
